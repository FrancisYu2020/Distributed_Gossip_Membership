...
do
    ...
    ssh tian23@fa22-cs425-220$val.cs.illinois.edu "cd ./mp2-hangy6-tian23; git pull origin dev; exit"
...
echo VM10 Updating
ssh tian23@fa22-cs425-2210.cs.illinois.edu "cd ./mp2-hangy6-tian23; git pull origin dev; exit"
